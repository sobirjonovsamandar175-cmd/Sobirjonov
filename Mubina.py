...
ADMINS = [1738809395]
ORDER_CHANNEL = "https://t.me/online_quiz_tests"

CARD_NUMBER = "9860190112173652"
CARD_HOLDER = "Sobirjonov Samandar"
...
gift_menu = InlineKeyboardMarkup([
    [InlineKeyboardButton("🧸 3,000 so'm", callback_data="gift_3000_🧸"), InlineKeyboardButton("💖 3,000 so'm", callback_data="gift_3000_💖")],
    [InlineKeyboardButton("🎁 5,000 so'm", callback_data="gift_5000_🎁"), InlineKeyboardButton("🌹 5,000 so'm", callback_data="gift_5000_🌹")],
    [InlineKeyboardButton("🎂 9,000 so'm", callback_data="gift_9000_🎂"), InlineKeyboardButton("💐 9,000 so'm", callback_data="gift_9000_💐")],
    [InlineKeyboardButton("🚀 9,000 so'm", callback_data="gift_9000_🚀"), InlineKeyboardButton("🏆 18,500 so'm", callback_data="gift_18500_🏆")],
    [InlineKeyboardButton("💍 18,500 so'm", callback_data="gift_18500_💍"), InlineKeyboardButton("💎 18,500 so'm", callback_data="gift_18500_💎")],
    [InlineKeyboardButton("◄ Orqaga", callback_data="target_back")]
])
